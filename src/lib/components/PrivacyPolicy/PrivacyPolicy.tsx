...
const PrivacyPolicy: React.FunctionComponent = () => {
  ...
  Sie haben jederzeit das Recht, unentgeltlich
   ...
   zu erhalten. Sie haben au&szlig;erdem ein Recht,
   die Berichtigung oder L&ouml;schung dieser Daten
   zu verlangen. Wenn Sie eine Einwilligung zur Datenverarbeitung
  ...
  Wenn Sie diese Website benutzen,
   ...
   mit denen Sie pers&ouml;nlich identifiziert
  ...
  Sie haben das Recht, Daten, die wir auf Grundlage
   ...
   in einem g&auml;ngigen, maschinenlesbaren Format aush&auml;ndigen
  ...
  Diese Seite nutzt aus Sicherheitsgr&uuml;nden
   ...
   als Seitenbetreiber senden, eine SSL- bzw. TLS-Verschl&uuml;sselung.
  ...
  Sie haben im Rahmen der geltenden
   ...
   &uuml;ber Ihre gespeicherten personenbezogenen
   Daten, deren Herkunft und Empf&auml;nger und den
   Zweck der Datenverarbeitung und ggf. ein Recht auf
   Berichtigung oder L&ouml;schung dieser Daten. Hierzu
  ...
  Sie haben das Recht, die Einschr&auml;nkung
   ...
   besteht in folgenden F&auml;llen:
    ...
    Wenn wir Ihre personenbezogenen Daten nicht
     ...
     Daten zu verlangen.</li> <li>Wenn Sie einen Widerspruch nach
     Art. 21 Abs. 1 DSGVO eingelegt haben, muss eine Abw&auml;gung
  ...
  Wenn Sie die Verarbeitung Ihrer personenbezogenen
   ...
   oder Verteidigung von Rechtsanspr&uuml;chen oder zum Schutz der
  ...
  Unsere Internetseiten verwenden so genannte
   ...
   die Dauer einer Sitzung (Session-Cookies) oder dauerhaft
  ...
  Cookies, die zur Durchf&uuml;hrung des elektronischen
   ...
   Funktionen (funktionale Cookies, z. B. f&uuml;r die Warenkorbfunktion)
   oder zur Optimierung der Webseite (z.B. Cookies zur Messung
  ...
  Die Erfassung dieser Daten erfolgt auf
   ...
   Interesse an der technisch fehlerfreien
  ...
  Wenn Sie uns per E-Mail, Telefon oder
   ...
   Daten (Name, Anfrage) zum Zwecke der Bearbeitung
  ...
  Die Verarbeitung dieser Daten erfolgt auf Grundlage
   ...
   In allen &uuml;brigen F&auml;llen beruht die
   Verarbeitung auf unserem berechtigten Interesse
   an der effektiven Bearbeitung der an uns
  ...
  Die von Ihnen an uns per Kontaktanfragen &uuml;bersandten
   ...
   oder der Zweck f&uuml;r die Datenspeicherung
  ...
  Wenn Sie eine Website besuchen, auf der OpenStreetMap
   ...
   an die OSMF weitergeleitet. OpenStreetMap speichert hierzu
   unter Umst&auml;nden Cookies in Ihrem Browser. Das sind Textdateien,
   die auf Ihrem Computer gespeichert werden und die eine Analyse der
   Benutzung der Website durch Sie erm&ouml;glichen. Sie k&ouml;nnen
   die Speicherung der Cookies durch eine entsprechende Einstellung
   Ihrer Browser-Software verhindern; wir weisen Sie jedoch
  ...
  Ferner kann Ihr Standort
   ...
   Der Anbieter dieser Seite hat keinen Einfluss auf
  ...
  Die Nutzung von OpenStreetMap erfolgt im Interesse einer
   ...
   angegebenen Orte. Dies stellt ein berechtigtes Interesse
